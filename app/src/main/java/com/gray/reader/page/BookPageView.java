...
import com.gray.reader.MyPoint;
...
public class BookPageView extends BasePage {
...
//        pathCPaint.setStyle(Paint.Style.STROKE);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        a.x = -1;
        a.y = -1;
        pathAContentBitmap = Bitmap.createBitmap(getDisplayWidth(), getDisplayHeight(), Bitmap.Config.RGB_565);
        drawPathAContentBitmap(pathAContentBitmap, pathAPaint);

        pathBContentBitmap = Bitmap.createBitmap(getDisplayWidth(), getDisplayHeight(), Bitmap.Config.RGB_565);
//        drawPathBContentBitmap(pathBContentBitmap, pathBPaint);

        pathCContentBitmap = Bitmap.createBitmap(getDisplayWidth(), getDisplayHeight(), Bitmap.Config.RGB_565);
    ...
    public ValueAnimator animCurrentToPrevious(float moveX, final float moveY, float mMoveX) {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                Log.e("aaa", curValue + "@");
                BookPageView.this.setTouchPoint(curValue, moveY, mode);
            }
        });
        return animator;
    }
